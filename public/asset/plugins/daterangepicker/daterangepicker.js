    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        if (
            ...
            options.template =
                ...
                '<span class="drp-selected" id="tgl" data-start=' +
    ...
    DateRangePicker.prototype = {
        ...
        updateView: function () {
            ...
            if (this.endDate)
                if (
                    ...
                    document
                        .getElementById("tgl")
                        .setAttribute("data-start", this.startDate.format("L"));
                    document
                        .getElementById("tgl")
                        .setAttribute("data-end", this.startDate.format("L"));
                    this.container
                        .find(".drp-selected")

                        .html(this.startDate.format("LLL"));
                } else {
                    document
                        .getElementById("tgl")
                        .setAttribute("data-start", this.startDate.format("L"));
                    document
                        .getElementById("tgl")
                        .setAttribute("data-end", this.endDate.format("L"));
                    this.container
                        .find(".drp-selected")
                        .html(
                            this.startDate.format("LLL") +
                                this.locale.separator +
                                this.endDate.format("LLL")
                        );
                }
            this.updateMonthsInView();
        ...
        updateElement: function () {
            if (this.element.is("input") && this.autoUpdateInput) {
                ...
                if (!this.singleDatePicker) {
                    if (newValue == this.endDate.format(this.locale.format)) {
                        newValue = newValue;
                    } else {
                        newValue +=
                            this.locale.separator +
